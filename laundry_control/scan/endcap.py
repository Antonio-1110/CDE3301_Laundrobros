...
on the MoveIt fake controller (URDF bucket): alpha 10/25/40 over
...
Re-bake after changing INTER, the URDF bucket/gripper, or the depth.
"""
    ...
    def save(self, path):
        ...
        with open(path, 'w') as handle:
            handle.write(
                ...
                '# re-bake after changing INTER, the URDF, or --depth.\n'
            )
