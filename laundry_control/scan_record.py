...
Client for the separate scan_recorder_node process (see
scan_recorder_node.py). All ToF capture, TF lookups, point-cloud
...
Two flavours of call are provided:
    ...
    *_async()    - fire-and-forget, returns immediately. Use ONLY
                   ...
                   arm-control node's spin loop in move.py.
